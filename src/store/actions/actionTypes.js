...
export const SHOW_NOTIFICATION = 'NOTIFICATION/SHOW_NOTIFICATION_MESSAGE';
export const CLICK_NOTIFICATION = 'NOTIFICATION/CLICK_NOTIFICATION';
export const DISMISS_NOTIFICATION = 'NOTIFICATION/DISMISS_NOTIFICATION_MESSAGE';
...
export const ADD_NEW_DYNAMIC_MESSAGE = 'MESSAGES/ADD_NEW_DYNAMIC_MESSAGE';
export const CHANGE_DYNAMIC_MESSAGE = 'MESSAGES/CHANGE_DYNAMIC_MESSAGE';
